...
- `DECISION_LOGIC_HAMZ.md` — `corrected` con `source_conflict` en lugares identificados; migrado intacto antes de editar y corregido contra las Partes 12-A/12-B: excepciones antes de patrones generales, pares y triples con awjuh correlacionados, naql/idghām/sakt en perfil, yāʾāt separadas, rasm inmutable y tashīl pendiente de validación oral. Hūd 11:72 y citas dudosas de p. 151 no se autorizan como decisiones automáticas.
